...
public class Fragment_main2_3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = null;
               v = inflater.inflate(R.layout.main2_3, null);
               Button bt;
    ...
    View.OnClickListener viewListener = new View.OnClickListener(){
        ...
        public void onClick(View v) {
            switch(v.getId()){
                case R.id.button_public_rate1:{
                    pager.setCurrentItem(12);
    				((SurveyActivity)(Fragment_main2_3.this.getActivity())).appendPreferences(1);	//1점 추가
                }break;
                case R.id.button_public_rate2:{
                    pager.setCurrentItem(12);
    				((SurveyActivity)(Fragment_main2_3.this.getActivity())).appendPreferences(1);	//1점 추가
                }break;
                case R.id.button_public_rate3:{
                    pager.setCurrentItem(12);
    				((SurveyActivity)(Fragment_main2_3.this.getActivity())).appendPreferences(1);	//1점 추가
                }break;
                case R.id.button_public_rate4:{
                    pager.setCurrentItem(12);
    				((SurveyActivity)(Fragment_main2_3.this.getActivity())).appendPreferences(1);	//1점 추가
                }break;
                case R.id.button_public_rate5:{
                    pager.setCurrentItem(12);
    				((SurveyActivity)(Fragment_main2_3.this.getActivity())).appendPreferences(1);	//1점 추가
                }break;
